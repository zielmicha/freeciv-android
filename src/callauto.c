...
static PyObject* python_can_unit_do_activity(PyObject* self, PyObject* args) {
	nptr_t arg_unit;
	nptr_t arg_activity;
	if(PyArg_ParseTuple(args, "LL", &arg_unit, &arg_activity) == 0) return NULL;
...
static PyObject* python_tile_activity_time(PyObject* self, PyObject* args) {
	nptr_t arg_activity;
	nptr_t arg_ptile;
	if(PyArg_ParseTuple(args, "LL", &arg_activity, &arg_ptile) == 0) return NULL;
...
static PyObject* python_request_new_unit_activity(PyObject* self, PyObject* args) {
	nptr_t arg_punit;
	nptr_t arg_act;
	if(PyArg_ParseTuple(args, "LL", &arg_punit, &arg_act) == 0) return NULL;
...
void* ptr;
	...
	PY_CALL("ssL", "add_function", "call_idle_callbacks", (nptr_t)ptr);
	ptr = python_client_start_server;
	PY_CALL("ssL", "add_function", "client_start_server", (nptr_t)ptr);
	ptr = python_connect_to_server;
	PY_CALL("ssL", "add_function", "connect_to_server", (nptr_t)ptr);
	ptr = python_real_timer_callback;
	PY_CALL("ssL", "add_function", "real_timer_callback", (nptr_t)ptr);
	ptr = python_input_from_server;
	PY_CALL("ssL", "add_function", "input_from_server", (nptr_t)ptr);
	ptr = python_py_dsend_packet_player_ready;
	PY_CALL("ssL", "add_function", "py_dsend_packet_player_ready", (nptr_t)ptr);
	ptr = python_send_chat;
	PY_CALL("ssL", "add_function", "send_chat", (nptr_t)ptr);
	ptr = python_control_mouse_cursor_pos;
	PY_CALL("ssL", "add_function", "control_mouse_cursor_pos", (nptr_t)ptr);
	ptr = python_recenter_button_pressed;
	PY_CALL("ssL", "add_function", "recenter_button_pressed", (nptr_t)ptr);
	ptr = python_recenter_at_tile_int;
	PY_CALL("ssL", "add_function", "recenter_at_tile_int", (nptr_t)ptr);
	ptr = python_init_mapcanvas_and_overview;
	PY_CALL("ssL", "add_function", "init_mapcanvas_and_overview", (nptr_t)ptr);
	ptr = python_map_canvas_resized;
	PY_CALL("ssL", "add_function", "map_canvas_resized", (nptr_t)ptr);
	ptr = python_init_things;
	PY_CALL("ssL", "add_function", "init_things", (nptr_t)ptr);
	ptr = python_update_map_canvas_visible;
	PY_CALL("ssL", "add_function", "update_map_canvas_visible", (nptr_t)ptr);
	ptr = python_update_map_canvas;
	PY_CALL("ssL", "add_function", "update_map_canvas", (nptr_t)ptr);
	ptr = python_get_mapview_store;
	PY_CALL("ssL", "add_function", "get_mapview_store", (nptr_t)ptr);
	ptr = python_key_unit_move_direction;
	PY_CALL("ssL", "add_function", "key_unit_move_direction", (nptr_t)ptr);
	ptr = python_key_unit_goto;
	PY_CALL("ssL", "add_function", "key_unit_goto", (nptr_t)ptr);
	ptr = python_update_line;
	PY_CALL("ssL", "add_function", "update_line", (nptr_t)ptr);
	ptr = python_key_cancel_action;
	PY_CALL("ssL", "add_function", "key_cancel_action", (nptr_t)ptr);
	ptr = python_key_unit_road;
	PY_CALL("ssL", "add_function", "key_unit_road", (nptr_t)ptr);
	ptr = python_key_unit_build_city;
	PY_CALL("ssL", "add_function", "key_unit_build_city", (nptr_t)ptr);
	ptr = python_key_unit_trade_route;
	PY_CALL("ssL", "add_function", "key_unit_trade_route", (nptr_t)ptr);
	ptr = python_key_unit_irrigate;
	PY_CALL("ssL", "add_function", "key_unit_irrigate", (nptr_t)ptr);
	ptr = python_key_unit_mine;
	PY_CALL("ssL", "add_function", "key_unit_mine", (nptr_t)ptr);
	ptr = python_key_unit_transform;
	PY_CALL("ssL", "add_function", "key_unit_transform", (nptr_t)ptr);
	ptr = python_key_unit_fortress;
	PY_CALL("ssL", "add_function", "key_unit_fortress", (nptr_t)ptr);
	ptr = python_key_unit_fortify;
	PY_CALL("ssL", "add_function", "key_unit_fortify", (nptr_t)ptr);
	ptr = python_key_unit_airbase;
	PY_CALL("ssL", "add_function", "key_unit_airbase", (nptr_t)ptr);
	ptr = python_key_unit_pollution;
	PY_CALL("ssL", "add_function", "key_unit_pollution", (nptr_t)ptr);
	ptr = python_key_unit_paradrop;
	PY_CALL("ssL", "add_function", "key_unit_paradrop", (nptr_t)ptr);
	ptr = python_key_unit_fallout;
	PY_CALL("ssL", "add_function", "key_unit_fallout", (nptr_t)ptr);
	ptr = python_key_unit_sentry;
	PY_CALL("ssL", "add_function", "key_unit_sentry", (nptr_t)ptr);
	ptr = python_key_unit_pillage;
	PY_CALL("ssL", "add_function", "key_unit_pillage", (nptr_t)ptr);
	ptr = python_key_unit_homecity;
	PY_CALL("ssL", "add_function", "key_unit_homecity", (nptr_t)ptr);
	ptr = python_key_unit_unload_all;
	PY_CALL("ssL", "add_function", "key_unit_unload_all", (nptr_t)ptr);
	ptr = python_key_unit_wait;
	PY_CALL("ssL", "add_function", "key_unit_wait", (nptr_t)ptr);
	ptr = python_key_unit_done;
	PY_CALL("ssL", "add_function", "key_unit_done", (nptr_t)ptr);
	ptr = python_key_unit_disband;
	PY_CALL("ssL", "add_function", "key_unit_disband", (nptr_t)ptr);
	ptr = python_key_unit_auto_explore;
	PY_CALL("ssL", "add_function", "key_unit_auto_explore", (nptr_t)ptr);
	ptr = python_action_button_pressed;
	PY_CALL("ssL", "add_function", "action_button_pressed", (nptr_t)ptr);
	ptr = python_free_ref;
	PY_CALL("ssL", "add_function", "free_ref", (nptr_t)ptr);
	ptr = python_key_end_turn;
	PY_CALL("ssL", "add_function", "key_end_turn", (nptr_t)ptr);
	ptr = python_meswin_get_num_messages;
	PY_CALL("ssL", "add_function", "meswin_get_num_messages", (nptr_t)ptr);
	ptr = python_meswin_get_message;
	PY_CALL("ssL", "add_function", "meswin_get_message", (nptr_t)ptr);
	ptr = python_finish_city_at_unit;
	PY_CALL("ssL", "add_function", "finish_city_at_unit", (nptr_t)ptr);
	ptr = python_cancel_city_at_unit;
	PY_CALL("ssL", "add_function", "cancel_city_at_unit", (nptr_t)ptr);
	ptr = python_canvas_pos_to_nearest_tile_id;
	PY_CALL("ssL", "add_function", "canvas_pos_to_nearest_tile_id", (nptr_t)ptr);
	ptr = python_set_mapview_origin;
	PY_CALL("ssL", "add_function", "set_mapview_origin", (nptr_t)ptr);
	ptr = python_get_map_view_origin;
	PY_CALL("ssL", "add_function", "get_map_view_origin", (nptr_t)ptr);
	ptr = python_get_units_in_focus;
	PY_CALL("ssL", "add_function", "get_units_in_focus", (nptr_t)ptr);
	ptr = python_get_units_at_tile;
	PY_CALL("ssL", "add_function", "get_units_at_tile", (nptr_t)ptr);
	ptr = python_can_unit_do_activity;
	PY_CALL("ssL", "add_function", "can_unit_do_activity", (nptr_t)ptr);
	ptr = python_tile_activity_time;
	PY_CALL("ssL", "add_function", "tile_activity_time", (nptr_t)ptr);
	ptr = python_unit_can_add_or_build_city;
	PY_CALL("ssL", "add_function", "unit_can_add_or_build_city", (nptr_t)ptr);
	ptr = python_unit_can_help_build_wonder_here;
	PY_CALL("ssL", "add_function", "unit_can_help_build_wonder_here", (nptr_t)ptr);
	ptr = python_can_unit_paradrop;
	PY_CALL("ssL", "add_function", "can_unit_paradrop", (nptr_t)ptr);
	ptr = python_can_unit_change_homecity;
	PY_CALL("ssL", "add_function", "can_unit_change_homecity", (nptr_t)ptr);
	ptr = python_get_unit_properties;
	PY_CALL("ssL", "add_function", "get_unit_properties", (nptr_t)ptr);
	ptr = python_get_unit_name;
	PY_CALL("ssL", "add_function", "get_unit_name", (nptr_t)ptr);
	ptr = python_request_new_unit_activity;
	PY_CALL("ssL", "add_function", "request_new_unit_activity", (nptr_t)ptr);
	ptr = python_set_unit_focus;
	PY_CALL("ssL", "add_function", "set_unit_focus", (nptr_t)ptr);
	ptr = python_city_dialog_redraw_map;
	PY_CALL("ssL", "add_function", "city_dialog_redraw_map", (nptr_t)ptr);
	ptr = python_get_citydlg_canvas_width;
	PY_CALL("ssL", "add_function", "get_citydlg_canvas_width", (nptr_t)ptr);
	ptr = python_get_citydlg_canvas_height;
	PY_CALL("ssL", "add_function", "get_citydlg_canvas_height", (nptr_t)ptr);
	ptr = python_city_unhappy;
	PY_CALL("ssL", "add_function", "city_unhappy", (nptr_t)ptr);
	ptr = python_city_happy;
	PY_CALL("ssL", "add_function", "city_happy", (nptr_t)ptr);
	ptr = python_city_celebrating;
	PY_CALL("ssL", "add_function", "city_celebrating", (nptr_t)ptr);
	ptr = python_city_get_prod;
	PY_CALL("ssL", "add_function", "city_get_prod", (nptr_t)ptr);
	ptr = python_city_get_size;
	PY_CALL("ssL", "add_function", "city_get_size", (nptr_t)ptr);
	ptr = python_city_turns_to_grow;
	PY_CALL("ssL", "add_function", "city_turns_to_grow", (nptr_t)ptr);
	ptr = python_city_granary_size;
	PY_CALL("ssL", "add_function", "city_granary_size", (nptr_t)ptr);
	ptr = python_city_production_turns_to_build;
	PY_CALL("ssL", "add_function", "city_production_turns_to_build", (nptr_t)ptr);
	ptr = python_city_get_shield_stock;
	PY_CALL("ssL", "add_function", "city_get_shield_stock", (nptr_t)ptr);
	ptr = python_city_name;
	PY_CALL("ssL", "add_function", "city_name", (nptr_t)ptr);
	ptr = python_city_get_production_image;
	PY_CALL("ssL", "add_function", "city_get_production_image", (nptr_t)ptr);
	ptr = python_city_get_production_cost;
	PY_CALL("ssL", "add_function", "city_get_production_cost", (nptr_t)ptr);
	ptr = python_city_get_production_name;
	PY_CALL("ssL", "add_function", "city_get_production_name", (nptr_t)ptr);
	ptr = python_city_get_citizen_count;
	PY_CALL("ssL", "add_function", "city_get_citizen_count", (nptr_t)ptr);
	ptr = python_city_rotate_specialist;
	PY_CALL("ssL", "add_function", "city_rotate_specialist", (nptr_t)ptr);
	ptr = python_city_map_click;
	PY_CALL("ssL", "add_function", "city_map_click", (nptr_t)ptr);
	ptr = python_city_change_production_type;
	PY_CALL("ssL", "add_function", "city_change_production_type", (nptr_t)ptr);
	ptr = python_get_units_present_in_city;
	PY_CALL("ssL", "add_function", "get_units_present_in_city", (nptr_t)ptr);
	ptr = python_get_playable_nation_count;
	PY_CALL("ssL", "add_function", "get_playable_nation_count", (nptr_t)ptr);
	ptr = python_city_style_of_nation_id;
	PY_CALL("ssL", "add_function", "city_style_of_nation_id", (nptr_t)ptr);
	ptr = python_get_name_of_nation_id;
	PY_CALL("ssL", "add_function", "get_name_of_nation_id", (nptr_t)ptr);
	ptr = python_set_nation_settings;
	PY_CALL("ssL", "add_function", "set_nation_settings", (nptr_t)ptr);
	ptr = python_disconnect_from_server;
	PY_CALL("ssL", "add_function", "disconnect_from_server", (nptr_t)ptr);
	ptr = python_get_buildable_improvements_in_city;
	PY_CALL("ssL", "add_function", "get_buildable_improvements_in_city", (nptr_t)ptr);
	ptr = python_get_buildable_units_in_city;
	PY_CALL("ssL", "add_function", "get_buildable_units_in_city", (nptr_t)ptr);
	ptr = python_set_tax_values;
	PY_CALL("ssL", "add_function", "set_tax_values", (nptr_t)ptr);
	ptr = python_get_tax_value;
	PY_CALL("ssL", "add_function", "get_tax_value", (nptr_t)ptr);
	ptr = python_get_gold_amount;
	PY_CALL("ssL", "add_function", "get_gold_amount", (nptr_t)ptr);
	ptr = python_get_gold_income;
	PY_CALL("ssL", "add_function", "get_gold_income", (nptr_t)ptr);
	ptr = python_get_techs;
	PY_CALL("ssL", "add_function", "get_techs", (nptr_t)ptr);
	ptr = python_set_tech_goal;
	PY_CALL("ssL", "add_function", "set_tech_goal", (nptr_t)ptr);
	ptr = python_get_current_tech;
	PY_CALL("ssL", "add_function", "get_current_tech", (nptr_t)ptr);
	ptr = python_get_current_year_name;
	PY_CALL("ssL", "add_function", "get_current_year_name", (nptr_t)ptr);
	ptr = python_get_governments;
	PY_CALL("ssL", "add_function", "get_governments", (nptr_t)ptr);
	ptr = python_change_government;
	PY_CALL("ssL", "add_function", "change_government", (nptr_t)ptr);
	ptr = python_py_accept_treaty;
	PY_CALL("ssL", "add_function", "py_accept_treaty", (nptr_t)ptr);
	ptr = python_py_cancel_treaty;
	PY_CALL("ssL", "add_function", "py_cancel_treaty", (nptr_t)ptr);
	ptr = python_call_callback;
	PY_CALL("ssL", "add_function", "call_callback", (nptr_t)ptr);
	ptr = python_city_production_buy_gold_cost;
	PY_CALL("ssL", "add_function", "city_production_buy_gold_cost", (nptr_t)ptr);
	ptr = python_city_can_buy;
	PY_CALL("ssL", "add_function", "city_can_buy", (nptr_t)ptr);
	ptr = python_city_buy_production;
	PY_CALL("ssL", "add_function", "city_buy_production", (nptr_t)ptr);
	ptr = python_get_turn_done_button_state;
	PY_CALL("ssL", "add_function", "get_turn_done_button_state", (nptr_t)ptr);
	ptr = python_get_built_improvements_in_city;
	PY_CALL("ssL", "add_function", "get_built_improvements_in_city", (nptr_t)ptr);
	ptr = python_get_unit_image;
	PY_CALL("ssL", "add_function", "get_unit_image", (nptr_t)ptr);
	ptr = python_authenticate;
	PY_CALL("ssL", "add_function", "authenticate", (nptr_t)ptr);
	ptr = python_get_players;
	PY_CALL("ssL", "add_function", "get_players", (nptr_t)ptr);
	ptr = python_player_name;
	PY_CALL("ssL", "add_function", "player_name", (nptr_t)ptr);
	ptr = python_set_tech_research;
	PY_CALL("ssL", "add_function", "set_tech_research", (nptr_t)ptr);
	ptr = python_can_unit_do_activity_base;
	PY_CALL("ssL", "add_function", "can_unit_do_activity_base", (nptr_t)ptr);
	ptr = python_set_unit_activity_base;
	PY_CALL("ssL", "add_function", "set_unit_activity_base", (nptr_t)ptr);
	ptr = python_impr_sell_gold;
	PY_CALL("ssL", "add_function", "impr_sell_gold", (nptr_t)ptr);
	ptr = python_can_city_sell_building;
	PY_CALL("ssL", "add_function", "can_city_sell_building", (nptr_t)ptr);
	ptr = python_city_sell_improvement_type;
	PY_CALL("ssL", "add_function", "city_sell_improvement_type", (nptr_t)ptr);
	ptr = python_nation_adjective_for_player;
	PY_CALL("ssL", "add_function", "nation_adjective_for_player", (nptr_t)ptr);
	ptr = python_nation_plural_for_player;
	PY_CALL("ssL", "add_function", "nation_plural_for_player", (nptr_t)ptr);
	ptr = python_can_meet_with_player;
	PY_CALL("ssL", "add_function", "can_meet_with_player", (nptr_t)ptr);
	ptr = python_py_init_meeting;
	PY_CALL("ssL", "add_function", "py_init_meeting", (nptr_t)ptr);
	ptr = python_player_by_number;
	PY_CALL("ssL", "add_function", "player_by_number", (nptr_t)ptr);
	ptr = python_player_number;
	PY_CALL("ssL", "add_function", "player_number", (nptr_t)ptr);
	ptr = python_py_get_nation_flag;
	PY_CALL("ssL", "add_function", "py_get_nation_flag", (nptr_t)ptr);
	ptr = python_get_playing;
	PY_CALL("ssL", "add_function", "get_playing", (nptr_t)ptr);
	ptr = python_py_add_clause;
	PY_CALL("ssL", "add_function", "py_add_clause", (nptr_t)ptr);
	ptr = python_py_cancel_pact;
	PY_CALL("ssL", "add_function", "py_cancel_pact", (nptr_t)ptr);
	ptr = python_py_get_dipl_state;
	PY_CALL("ssL", "add_function", "py_get_dipl_state", (nptr_t)ptr);
	ptr = python_py_gives_shared_vision;
	PY_CALL("ssL", "add_function", "py_gives_shared_vision", (nptr_t)ptr);
	ptr = python_py_overview_click;
	PY_CALL("ssL", "add_function", "py_overview_click", (nptr_t)ptr);
	ptr = python_request_toggle_city_full_bar;
	PY_CALL("ssL", "add_function", "request_toggle_city_full_bar", (nptr_t)ptr);
}
