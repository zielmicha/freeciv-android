...
#define FC_STORE_CPPFLAGS ' -DLOCALEDIR="\"${datarootdir}/locale\"" -DFC_CONF_PATH="\".:data:~/.freeciv/2.6:${datarootdir}/freeciv:/mnt/savegames\"" -DDEFAULT_DATA_PATH="\".:data:~/.freeciv/2.6:${datarootdir}/freeciv:/mnt/savegames\""'
