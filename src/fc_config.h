...
/* Bug reporting URL */
#define BUG_URL "https://github.com/zielmicha/freeciv-android/issues"
...
#define FC_STORE_CPPFLAGS ' -DLOCALEDIR="\"${datarootdir}/locale\"" -DFC_CONF_PATH="\".:data:~/.freeciv/2.5:${datarootdir}/freeciv:/mnt/savegames\"" -DDEFAULT_DATA_PATH="\".:data:~/.freeciv/2.5:${datarootdir}/freeciv:/mnt/savegames\""'
...
#define NEXT_STABLE_VERSION "2.5.7"
