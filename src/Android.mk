...
LOCAL_SRC_FILES := common/ai.c common/base.c common/borders.c common/capstr.c common/city.c common/combat.c common/connection.c \
    ...
    common/tile.c common/unit.c common/unitlist.c common/unittype.c common/version.c common/vision.c common/worklist.c \
    common/aicore/aisupport.c common/aicore/caravan.c common/aicore/citymap.c common/aicore/cm.c common/aicore/path_finding.c \
    common/aicore/pf_tools.c client/attribute.c client/audio.c client/audio_none.c client/chatline_common.c \
    client/citydlg_common.c client/cityrepdata.c client/client_main.c client/climap.c client/climisc.c client/clinet.c \
    client/colors_common.c client/connectdlg_common.c client/control.c client/dummy.c client/editor.c client/ggzclient.c \
    client/global_worklist.c client/goto.c client/helpdata.c client/mapctrl_common.c client/mapview_common.c client/messagewin_common.c \
    client/options.c client/overview_common.c client/packhand.c client/packhand_gen.c client/plrdlg_common.c client/repodlgs_common.c \
    client/reqtree.c client/servers.c client/text.c client/themes_common.c client/tilespec.c client/voteinfo.c callauto.c clientauto.c \
