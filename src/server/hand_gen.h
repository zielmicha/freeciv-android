...
void handle_player_attribute_chunk_CLIENT(struct player *pplayer, const struct packet_player_attribute_chunk *packet);
void handle_player_attribute_chunk_SERVER(struct player *pplayer, const struct packet_player_attribute_chunk *packet);
...
void handle_scenario_info_CLIENT(struct connection *pc, const struct packet_scenario_info *packet);
void handle_scenario_info_SERVER(struct connection *pc, const struct packet_scenario_info *packet);
...
void handle_edit_startpos_CLIENT(struct connection *pc, const struct packet_edit_startpos *packet);
void handle_edit_startpos_SERVER(struct connection *pc, const struct packet_edit_startpos *packet);
struct packet_edit_startpos_full;
void handle_edit_startpos_full_CLIENT(struct connection *pc, const struct packet_edit_startpos_full *packet);
void handle_edit_startpos_full_SERVER(struct connection *pc, const struct packet_edit_startpos_full *packet);
